...
<script>
import { createTopic } from '@/api/activity/topic'
import { listGoods } from '@/api/goods/list'
// import { addStorage, deleteStorage } from '@/api/system/storage'
...
export default {
  ...
  data() {
    return {
      ...
      deletePath:process.env.BASE_API+'/storage/delete',
  ...
  methods: {
    ...
    handleCancel() {
      this.$router.push({ path: '/activity/topic' })
    },
    handleConfirm() {

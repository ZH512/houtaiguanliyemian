...
export const asyncRouterMap = [
...

  {
    ...
    children: [
      ...
      {
        path: 'category',
        component: () => import('@/views/malls/category'),
        name: 'category',
        meta: {
          perms: ['GET /admin/brand/list', 'POST /admin/category/create', 'POST /admin/category/update', 'POST /admin/category/delete'],
          title: '商品类目',
          noCache: true
        }
      },
      ...
      {
        path: 'issue',
        component: () => import('@/views/malls/issue'),
        name: 'issue',
        meta: {
